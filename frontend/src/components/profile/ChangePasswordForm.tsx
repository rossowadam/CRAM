    ...
    return (
        <form className="flex flex-col" onSubmit={onChangePassword}>
            <div className="flex flex-col sm:p-2 gap-4 w-full">
                <PasswordInput placeholder="Enter current password" password={currentPassword} setPassword={setCurrentPassword} />

                <div>
                    <PasswordInput placeholder="Enter new password" password={newPassword} setPassword={setNewPassword} />
